...
public class GuiListEditScreen extends MenuScreen {
    ...
    protected void drawContent(int mouseX, int mouseY) {
        ...
        if (this.entries.isEmpty()) {
            ...
            this.fontRendererObj.drawString(empty, this.panelX1 + this.padding + 10,
                    this.listTop + 12,
        ...
        // typed in half.
        if (this.editor != null) {
            Draw.rect(this.editor.xPosition - 3, this.editor.yPosition - 3,
                    this.editor.xPosition + this.editor.width + 3, this.editor.yPosition + 13,
                    Draw.withAlpha(Theme.surface, 0.92F * this.fadeAlpha));
            Draw.rect(this.editor.xPosition - 3, this.editor.yPosition + 12,
                    this.editor.xPosition + this.editor.width + 3, this.editor.yPosition + 13,
    ...
    private final class EntryList extends ScrollList {
        ...
        protected void drawRow(int index, int rowX, int rowY, int rowWidth, int rowHeight,
            ...
            if (!beingEdited) {
                ...
                GuiListEditScreen.this.fontRendererObj.drawString(
    ...
    private void beginEditing(int index) {
        ...
        this.editor = new GuiTextField(this.fontRendererObj, x, rowY + 5,
