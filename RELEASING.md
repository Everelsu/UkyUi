...
| Version number     | `version` in `build.gradle.kts`. Modrinth gets it with the Minecraft version on the end — `0.5.4+1.7.10` — because both branches release the same mod version and Modrinth will not take that number twice |
